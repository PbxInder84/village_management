...
import { fetchPanchayatMembers, selectAllMembers } from '../features/panchayatMembers/panchayatMembersSlice';
                          ...
                          <div className="mt-2 space-y-2 w-full">
                            {member.contact && (
                              <div className="flex items-center text-sm text-gray-500">
                                ...
                                <a href={`tel:${member.contact}`} className="hover:text-primary-600">
                                  {member.contact}
                                </a>
                              </div>
                            )}
